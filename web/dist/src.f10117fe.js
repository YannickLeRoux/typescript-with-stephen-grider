...
function () {
  ...
  Object.defineProperty(Model.prototype, "trigger", {
    // short syntax:  on = this.events.on;
    get: function get() {
      return this.events.trigger;
    },
    enumerable: true,
...
function (_super) {
  ...
  User.buildUserCollectiion = function () {
...
users.fetch();
},{"./views/UserList":"src/views/UserList.ts","./models/Collection":"src/models/Collection.ts","./models/User":"src/models/User.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
