...
function () {
  ...
  User.prototype.fetch = function () {
    ...
    axios_1["default"].get(url + this.get('id')).then(function (response) {
  ...
  User.prototype.save = function () {
    ...
    if (id) {
      //put
      axios_1["default"].put(url + id, this.data);
    } else {
      //post
      axios_1["default"].post(url, this.data);
    }
  };
...
user.save();
},{"./models/User":"src/models/User.ts"}],"../../../../.nvm/versions/node/v10.15.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../.nvm/versions/node/v10.15.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
